...
class Property(TimeStampedUUIDModel):
    ...
    default = "Default descriptio....update me please",)
    country = CountryField(
        verbose_name = _("Country"),
        default = "NP",
        blank_label = "(select county)",
    )
    city = models. CharField(verbose_name= _("City"), max_length = 180,
    default = "Kathmandu")
    postal_code = models.CharField(verbose_name = _("Postal code"),
    max_length = 100, default = "440")
    street_address = models.CharField(verbose_name = _("Street Address"), max_length = 150, default = "Har har mahadev")
    ...
    plot_area = models.DecimalField(verbose_name = _("Plot Area"),
    max_digits = 8, decimal_places = 2, default= 0.0 
    )
    total_floors = models.IntegerField(verbose_name = ("Number of Floors"),
    default = 0)
    ...
    def final_property_price(self):
        ...
        price_after_tax = float(round(property_price + tax+amount, 2 ))
